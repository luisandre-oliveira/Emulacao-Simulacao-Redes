...
public class SerialPortTest
{
    ...
    static public void main(String[] args)
    {
        ...
        ubxPort.writeBytes(ant.getBytes(),12345);
        System.out.println("\nWaiting for available bytes to read...SDSAD---L134");
